    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            //MY ODDS 
            //create a moethod that will remove all odd numbers from the list then print results 
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
            ...
            {
                Console.WriteLine($"This does indeed seem to be the number!");
            }
            else
            {
                Console.WriteLine($"This is not the one you seek!");
            }
        }
